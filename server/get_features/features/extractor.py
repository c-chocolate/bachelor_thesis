...
#from extractors.dns_features_extractor import *
#from extractors.domain_name_features_extractor import *
#from extractors.web_features_extractor import *


class Extractor:
    def __init__(self, domain, name, dns, web, addweb):
        if name:
        ...
        if addweb:
            self.add_web_features_extractor = Add_Web_Features_Extractor(domain)
    ...
    def get_n_css_selectors(self):
        return self.add_web_features_extractor.get_n_css_selectors()
    def get_html_id_class_num(self):
        return self.add_web_features_extractor.get_html_id_class_num()
    def get_html_id_class_rate(self):
        return self.add_web_features_extractor.get_html_id_class_rate()
    def get_n_js_function(self):
        return self.add_web_features_extractor.get_n_js_function()
    def get_js_comparison_average(self):
        return self.add_web_features_extractor.get_js_comparison_average()
    def get_js_comparison_max(self):
        return self.add_web_features_extractor.get_js_comparison_max()
    def get_js_comparison_min(self):
        return self.add_web_features_extractor.get_js_comparison_min()
